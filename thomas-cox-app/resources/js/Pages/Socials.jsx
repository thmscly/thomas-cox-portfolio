        ...
        <div className="font-mono text-green-600 text-center max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-3 gap-4 m-5">
                <a href="https://rachelcoxart.com/">
                    <div className="text-4xl m-3">
                        ...
                        <p className="text-base m-2">
                            An e-commerce shopping site built with React to sell
                            my wife's art. It's deployed with Netlify and will
                            have a Stripe integration.
                        </p>
                    </div>
                </a>
                <a href="/projects">
                ...
                <a href="/projects">
                    <div className="text-4xl m-3">
                        GitHub
                        <p className="text-base m-2">That way lies Repos.</p>
                    </div>
                </a>
            </div>
        </div>
